...
const char* password = "cutannisa123";
...
const char* client_name = "G.231.21.0214";
...
if (message == "{\"nim\":\"G.231.21.0214\",\"D3\":1}") {

digitalWrite(led1, HIGH);

} else if (message == "{\"nim\":\"G.231.21.0214\",\"D3\":0}") {

digitalWrite(led1, LOW);

}

if (message == "{\"nim\":\"G.231.21.0214\",\"D4\":1}") {

digitalWrite(led2, HIGH);

} else if (message == "{\"nim\":\"G.231.21.0214\",\"D4\":0}") {

digitalWrite(led2, LOW);

}

if (message == "{\"nim\":\"G.231.21.0214\",\"D5\":1}") {

digitalWrite(led3, HIGH);

} else if (message == "{\"nim\":\"G.231.21.0214\",\"D5\":0}") {

digitalWrite(led3, LOW);

}

if (message == "{\"nim\":\"G.231.21.0214\",\"D6\":1}") {

digitalWrite(led4, HIGH);

} else if (message == "{\"nim\":\"G.231.21.0214\",\"D6\":0}") {
